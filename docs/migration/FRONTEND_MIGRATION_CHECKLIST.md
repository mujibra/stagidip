...
- Execution status: `docs/migration/PARITY_EXECUTION_STATUS.md`
- Status legend:
...
|---|---|---|---|---|
| Dashboard | `dashboard/dashboardConfig.js` | `/dashboard` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_DASHBOARD.md`. |
| Purchase Order | `porchase-order/porchaseOderConfig.js` | `/purchase-order` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_PURCHASE_ORDER.md`. |
| Summary | `summary/SummaryConfig.js` | `/summary` | ✅ | Parity audit completed with PR C baseline evidence (`done`): `docs/migration/PARITY_AUDIT_SUMMARY.md`. |
| Integration | `mydatindo-integration/mydatindoIntegrationConfig.js` | `/integration/my-datindo` | ✅ | Parity audit completed with PR C baseline evidence (`done`): `docs/migration/PARITY_AUDIT_INTEGRATION.md`; `/integration` redirects to canonical child. |
| Spesification | `spesification/SpesificationConfig.js` | `/spesification` | ✅ | Parity audit completed with PR C baseline evidence (`done`): `docs/migration/PARITY_AUDIT_SPESIFICATION.md`. |
| Registration | `registration/RegistrationConfig.js` | `/registration` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_REGISTRATION.md`. |
| Warehouse Transfer | `warehouse-transfer/WarehouseTransferConfig.js` | `/warehouse-transfer` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_WAREHOUSE_TRANSFER.md`. |
| Status Delivery | `status-delivery/statusDeliveryAppConfig.js` | `/status-delivery` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_STATUS_DELIVERY.md`. |
| Pre Staging Checklist | `preStaging/CheklistStagingConfig.js` | `/pre-staging/checklist` | ✅ | Parity audit completed with PR D baseline evidence (`done`): `docs/migration/PARITY_AUDIT_STAGING.md`. |
| Stagging Old Machine | `stagging/oldMachine/oldMachineAppConfig.js` | `/staging/old-machine` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_STAGING.md`. |
| Stagging New Machine | `stagging/newMachine/NewMachineAppConfig.js` | `/staging/new-machine` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_STAGING.md`. |
| Stagging View Staging | `stagging/viewStagging/ViewStagingConfig.js` | `/staging` | ✅ | Parity audit completed with PR D baseline evidence (`done`): `docs/migration/PARITY_AUDIT_STAGING.md`. |
| Stagging Inspeksi | `stagging/inspeksiTesting/InspeksiConfig.js` | `/staging/inspection-testing` | ✅ | Parity audit completed: `docs/migration/PARITY_AUDIT_STAGING.md`. |
