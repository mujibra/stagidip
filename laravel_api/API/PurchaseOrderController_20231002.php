    ...
    public function getDataStagingBasedOnRowMesin($idPo, $rowNum){
        try {
            ...
            select x.* from (
                ...
                mpn.part_desc, 
                mpn.part_column, 
                (select min(position) from mst_part_number xx where xx.part_column = mpn.part_column) get_position
                from mst_part_number mpn
            ...
            $query1 .=') and id_mesin ='.$selectPo->id_type_mesin.' ) x  order by x.get_position IS NULL, x.get_position ASC';
