...
const HandleExportExcel = props => {
  ...
  function exportExcel() {
    ...
    const sheet = workbook.addWorksheet('Data Pre Staging');
    const worksheet = workbook.getWorksheet('Data Pre Staging');

    /* TITLE */
    worksheet.mergeCells('A1', 'G1');
    worksheet.getCell('A1').value = 'Data Pre Staging';
    ...
    (async () => {
      ...
      saveAs(blob, `Data Pre Staging ${moment().format('LL')}${fileExtension}`);
    })();
  }
