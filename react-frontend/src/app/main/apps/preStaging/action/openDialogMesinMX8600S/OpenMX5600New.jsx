          ...
          <div className="flex justify-between">
            ...
            <div>
              {props?.row?.disable === true ? (
                ...
                <Button
                  disabled={props?.row?.disable === true || loadingBtn === true ||
                    userRoles === 'GUEST' ||
                    userRoles === 'OPERATOR_TSS' ||
                    userRoles === 'GUEST_BANK' ||
                    userRoles === 'GUEST_DIP' ||
                          ...
                          {index === 0 ? (
                            ...
                            >
                              <>
                                ...
                                <img
                                  src={
                                    row?.checklistStaging[3]?.detail_staging
                                      ?.fill_columns
                                  }
                                  alt="Gambar Kosong"
                                />
...
export default function OpenMX5600New(props) {
