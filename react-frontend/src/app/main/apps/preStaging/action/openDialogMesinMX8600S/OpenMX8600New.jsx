                          ...
                          {index === 0 ? (
                            ...
                            <TableCell align="center" className={classes?.tableCell}>
                              <>
                                ...
                                <img
                                  src={row?.checklistStaging[4]?.detail_staging?.fill_columns}
                                  alt="Gambar Kosong"
                                />
                                <div className="mb-10">
                                  {getSizeErr > 2097152 ? (
...
export default function OpenMX8600New(props) {
  ...
  // props?.propsFromParrentNew(rows);
