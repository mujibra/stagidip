...
function createData(id, checkpoint_desc, detail_staging) {
  return { id, checkpoint_desc, detail_staging };
}

export default function OpenExteriorCheckEdit(props) {
  ...
  const rows = data?.map((item, index) =>
    createData(item?.id, item?.checkpoint_desc, item?.detail_staging)
  );
