...
export default function OpenMX5600OnePage(props) {
  ...
  useEffect(() => {
    if (pageState.length !== 0) {
      const objIndex = pageState.findIndex((obj) => obj.id_checklist_staging === 7);
      pageState[objIndex].fill_columns =
        encodedData === null ? datas[6]?.detail_staging?.fill_columns : encodedData;
    }
                    ...
                    <div className="flex gap-10 justify-between">
                      ...
                      <div>
                        <Autocomplete
                          ...
                          getOptionSelected={(option) => option?.id}
                          onChange={(e, newValue) => {
                            handleFillColomns(newValue, index, true, 1, 'dev');
                          }}
                          defaultValue={
                            row.detail_staging?.fill_columns === null
                              ? dev2
                      ...
                      <div>
                        <Autocomplete
                          ...
                          onChange={(e, newValue) => {
                            handleFillColomns(newValue, index, true, 2, 'dev');
                          }}
                          disablePortal
                          // id="combo-box-demo"
                          options={DataDenomination}
                      ...
                      <div>
                        <Autocomplete
                          ...
                          onChange={(e, newValue) => {
                            handleFillColomns(newValue, index, true, 3, 'dev');
                          }}
                          disablePortal
                          // id="combo-box-demo"
                          options={DataDenomination}
                      ...
                      <div>
                        <Autocomplete
                          ...
                          onChange={(e, newValue) => {
                            handleFillColomns(newValue, index, true, 4, 'dev');
                          }}
                          disablePortal
                          // id="combo-box-demo"
                          options={DataDenomination}
