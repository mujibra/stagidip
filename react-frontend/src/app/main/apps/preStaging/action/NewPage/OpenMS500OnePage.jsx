...
export default function OpenMS500OnePage(props) {
        ...
        fill_columns:
          i === 3
            ...
            ? [
                ...
                datas[i]?.detail_staging?.fill_columns === null
                  ? dev6
                  : datas[i]?.detail_staging?.fill_columns[5]?.id === undefined
                  ? null
                  : datas[i]?.detail_staging?.fill_columns[5]?.id,
                datas[i]?.detail_staging?.fill_columns === null
                  ? dev7
                  : datas[i]?.detail_staging?.fill_columns[6]?.id === undefined
                  ? null
                  : datas[i]?.detail_staging?.fill_columns[6]?.id,
              ]
            : i === 6
            ? bcu === null
  ...
  useEffect(() => {
    if (pageState.length !== 0) {
      const objIndex = pageState.findIndex((obj) => obj.id_checklist_staging === 200);
      pageState[objIndex].fill_columns =
        encodedData === null ? datas[7]?.detail_staging?.fill_columns : encodedData;
    }
                      ...
                      <div>
                        <Autocomplete
                          ...
                          defaultValue={
                            row.detail_staging?.fill_columns === null
                              ? dev6
                              : row?.detail_staging?.fill_columns[5]
                          }
                          onChange={(e, newValue) => {
                            handleFillColomns(newValue?.id, index, true, 5, 'dev');
                          }}
                          disablePortal
                          // id="combo-box-demo"
                          options={DataDenomination}
                      ...
                      <div>
                        <Autocomplete
                          ...
                          defaultValue={
                            row.detail_staging?.fill_columns === null
                              ? dev7
                              : row?.detail_staging?.fill_columns[6]
                          }
                          onChange={(e, newValue) => {
                            handleFillColomns(newValue?.id, index, true, 6, 'dev');
                          }}
                          disablePortal
                          // id="combo-box-demo"
                          options={DataDenomination}
