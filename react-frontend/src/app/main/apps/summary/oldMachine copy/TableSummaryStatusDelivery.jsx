...
function createData(id, no_po, customer, sn_mesin, tgl_perkiraan_tiba, nama_gudang, detailPo) {
  return {
    id,
    no_po,
    customer,
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          List of Summary Delivery Status
        </Typography>
      )}
...
export default function TableSummaryStatusDelivery(props) {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.detailPo?.no_po === '' ||
                          row?.detailPo?.no_po === null ||
                          row?.detailPo?.no_po === undefined
                            ? '-'
                            : row?.detailPo?.no_po}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.detailPo?.customer?.bank_desc === '' ||
                          row?.detailPo?.customer?.bank_desc === null ||
                        ...
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.sn_mesin === '' ||
                          row?.sn_mesin === null ||
                          row?.sn_mesin === undefined
                            ? '-'
                            : row?.sn_mesin}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.tgl_perkiraan_tiba === undefined ||
                          row?.tgl_perkiraan_tiba === null ||
                          row?.tgl_perkiraan_tiba === ''
                            ? '-'
                            : moment(row?.tgl_perkiraan_tiba).format('ll')}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.detailPo?.gudang?.gudang_desc === '' ||
                          row?.detailPo?.gudang?.gudang_desc === undefined
                            ? '-'
                            : row?.detailPo?.gudang?.gudang_desc}
                        </TableCell>
                      </TableRow>
