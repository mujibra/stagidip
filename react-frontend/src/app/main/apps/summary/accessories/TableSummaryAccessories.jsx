...
const headCells = [
  ...
  {
    id: 'concat_tipe_aksesoris',
    numeric: true,
    disablePadding: false,
    label: 'Tipe Accessories',
  },
  {
    id: 'concat_jenis_aksesoris',
    numeric: true,
    disablePadding: false,
...
export default function TableSummaryAccessories(props) {
  ...
  const datas = props?.data?.list_items?.items?.map((item, index) =>
    createData(
      // index + 1,
      item?.part_sn,
      item?.merk_aksesoris,
      item?.concat_tipe_aksesoris,
      item?.concat_jenis_aksesoris,
      item?.sn_paketmesin,
      item?.no_baris_mesin,
      item?.nama_gudang
    )
                    ...
                    return (
                      ...
                      {rowsPerPage * page + index + 1}.)
                        ...
                        <TableCell
                          ...
                          className={classes?.tableCell}
                        >
                          {row?.concat_tipe_aksesoris === null
                            ? '-'
                            : row?.concat_tipe_aksesoris}
                        </TableCell>
                        <TableCell
                          align="center"
                          className={classes?.tableCell}
                        >
                          {row?.concat_jenis_aksesoris === null
                            ? '-'
                            : row?.concat_jenis_aksesoris}
                        </TableCell>
                        <TableCell
                          align="center"
                          className={classes?.tableCell}
                        >
                          {row?.sn_paketmesin === null
                            ? '-'
                            : row?.sn_paketmesin}
                        </TableCell>
                        <TableCell
                        ...
                        <TableCell
                          ...
                          className={classes?.tableCell}
                        >
                          {row?.nama_gudang === null ? '-' : row?.nama_gudang}
                        </TableCell>
                      </TableRow>
                    );
                  })}
