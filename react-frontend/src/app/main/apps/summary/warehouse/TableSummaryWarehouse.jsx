...
export default function TableSummaryWarehouse(props) {
  ...
  const sumTotalSummary = [
    {
      id: 'sumQuantityBeforeDelvivery',
      name: 'Sum Quantity Before Delivery',
      total: sumQuantityBeforeDelvivery,
    },
    {
      id: 'sumQuantityDelivery',
      name: 'Sum Quantity Delivery',
      total: sumQuantityDelivery,
    },
    {
      id: 'sumBalance',
      name: 'Sum Balance',
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.styles === null || row?.styles === '' ? '-' : row?.styles}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.qty_before_delivery === null || row?.qty_before_delivery === ''
                            ? '-'
                            : row?.qty_before_delivery}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.qty_delivery === null || row?.qty_delivery === ''
                            ? '-'
                            : row?.qty_delivery}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
                          {row?.qty_before_delivery - row?.qty_delivery}
                        </TableCell>
                        <TableCell align="left" className={classes?.tableCell}>
