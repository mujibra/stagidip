...
const columns = [
  ...
  { id: 'persen_ba', label: 'BA No Available', minWidth: 90 },
  { id: 'total_kirim', label: 'No Delivery', minWidth: 90 },
  { id: 'total_kirim', label: '% Activation', minWidth: 110 },
  { id: 'total_kirim', label: 'Activation No Available', minWidth: 90 },
];
...
const headCells = [
  ...
  {
    id: 'activationNoAvailable',
    numeric: true,
    disablePadding: false,
    label: 'Activation No Available',
  },
  // {
  //   id: 'reportDetail',
  //   numeric: true,
...
export default function TableImplementation(props) {
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.persen_kirim === null ? `${0}%` : `${row?.persen_kirim}%`}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.total_activated === null ? 0 : row?.total_activated}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.total_ba === null ? 0 : row?.total_ba}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.persen_ba === null ? `${0}%` : `${row?.persen_ba}%`}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {(row?.total_activated === null ? 0 : row?.total_activated) -
                            (row?.total_ba === null ? 0 : row?.total_ba)}
                        ...
                        <TableCell align="center" className={classes?.tableCell}>
                          {`${
                            Math.round(
                              ((row?.total_activated === null ? 0 : row?.total_activated) * 100) /
                                (row?.quantity === null ? 0 : row?.quantity)
                            ) === Infinity ||
                            isNaN(
                              Math.round(
