...
function createData(customer_name, types, models, QTY_DELIV, QTY_WITHDRAW, purpose) {
  return {
    customer_name,
    types,
    models,
    ...
    <TableHead className="bg-blue-50">
      <TableRow>
        ...
        {headCells.map((headCell) => (
          <TableCell
            key={headCell.id}
            align={headCell.id === 'customer' ? 'left' : 'center'}
            // align="center"
...
export default function TableDevelopmentSummary(props) {
  ...
  const sumTotalSummary = [
    {
      id: 'sumQuantityDelvivery',
      name: 'Sum Quantity Delivery',
      total: sumQuantityDelvivery,
    },
    {
      id: 'sumQuantityWithdrawal',
      name: 'Sum Quantity Withdrawal',
      total: sumQuantityWithdrawal,
    },
    {
      id: 'sumBalance',
      name: 'Sum Balance',
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center" className={classes?.tableCell}>
                          {parseInt(row?.QTY_DELIV) === null || parseInt(row?.QTY_DELIV) === ''
                            ? '-'
                            : parseInt(row?.QTY_DELIV)}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {parseInt(row?.QTY_WITHDRAW) === null ||
                          parseInt(row?.QTY_WITHDRAW) === ''
                            ? '-'
                            : parseInt(row?.QTY_WITHDRAW)}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {parseInt(row?.QTY_DELIV) - parseInt(row?.QTY_WITHDRAW)}
                        </TableCell>
                      </TableRow>
                    );
                  })}
