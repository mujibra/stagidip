...
const HandleExportExcel = (props) => {
  ...
  function exportExcel() {
    ...
    const sheet = workbook.addWorksheet('SUMMARY OLD MAVHINE');
    const worksheet = workbook.getWorksheet('SUMMARY OLD MAVHINE');

    /* TITLE */
    worksheet.mergeCells('A1', 'G1');
    worksheet.getCell('A1').value = 'SUMMARY OLD MACHINE';
    ...
    (async () => {
      ...
      saveAs(blob, `Summary Old Machine ${moment().format('LL')}${fileExtension}`);
    })();
  }
