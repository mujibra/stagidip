...
function createData(id, sn_mesin, brand, models, model_by_customer, types, no_baris_mesin, gudang) {
  return {
    id,
    sn_mesin,
    brand,
...
export default function TableSummaryMachine(props) {
  // console.log(props, 'poporsoap');
                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.model_by_customer === null ? '-' : row?.model_by_customer}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.id === 'Bank Central Asia' && row?.types === 'ATMS'
                            ? 'ATM'
                            : row?.id === 'Bank Central Asia' && row?.types === 'CRMS'
                            ? 'CRM'
                            : row?.types}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
                          {row?.no_baris_mesin === '' || row?.no_baris_mesin === null
                            ? '-'
                            : row?.no_baris_mesin}
                        </TableCell>
                        <TableCell align="center" className={classes?.tableCell}>
