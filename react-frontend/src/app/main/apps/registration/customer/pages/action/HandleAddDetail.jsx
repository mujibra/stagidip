            ...
            >
              <div className=" w-full flex gap-10 flex-col md:flex-row ">
                <TextField
                  ...
                  label="Customer Name"
                  type="text"
                  value={body?.bank_desc}
                  // error={body?.bank_desc <= '0'}
                  // helperText={body?.bank_desc <= '0' ? '*No Po Tidak Boleh kurang dari 1!' : ''}
                  // focused
                  onChange={(e) => setBody?.setbank_desc(e.target.value)}
                />
              </div>
        ...
        <div>
          <div className="flex justify-end mt-10">
            ...
            {props.loading === true ? (
              ...
              <Button
                disabled={body.bank_desc === "" || body.address === ""}
                onClick={props.HandleSubmit}
                variant="contained"
