      ...
      <FusePageCarded
        ...
        contentToolbar={
          <div className="flex flex-1 w-full items-center justify-between">
              ...
              <div>
                <FuseAnimate animation="transition.slideLeftIn" delay={100}>
                  ...
                  <Button variant="contained" onClick={handleClickOpens}>
                    ...
                    <div className="hidden md:contents">Add New Style</div>
                  </Button>
                  {/* </Link> */}
                </FuseAnimate>
              </div>
            ...
            >
              <DialogTitle id="alert-dialog-title">Add New Style</DialogTitle>
              <Divider />
              <DialogContent>
