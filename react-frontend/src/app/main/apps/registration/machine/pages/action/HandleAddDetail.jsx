            ...
            >
              <div className=" w-full flex gap-10 mt-10 flex-col md:flex-row ">
                <Autocomplete
                  ...
                  onFocus={handleFocus}
                  options={DataBrand}
                  value={body.merek.name}
                  fullWidth
                  // disabled={loadingModel === true}
                  getOptionLabel={(n) => (n?.name === undefined ? "" : n?.name)}
                  getOptionSelected={(option) =>
                    option?.label === body.merek.name
                  }
                  loading={loadingBrand === true}
                  onChange={(_event, newValue) => {
                    if (newValue) {
                      setBody.setmerek(newValue.name);
                    } else {
                      setBody.setmerek("");
                    }
                  }}
              ...
              <div className="w-full flex gap-10 mt-10 flex-col md:flex-row">
                <TextField
                  ...
                  // focused
                  onChange={(e) => setBody?.settype(e.target.value)}
                />
              </div>
            </Box>
          </div>
        ...
        <div>
          <div className="flex justify-end mt-10">
            ...
            {props.loading === true ? (
              ...
              <Button
                disabled={
                  body.model === "" || body.brand === "" || body.type === ""
                }
                onClick={props.HandleSubmit}
                variant="contained"
