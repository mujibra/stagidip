...
import TableStagingPic from './TableStagingPic';
  ...
  const HandleSubmit = async (event) => {
    ...
    const response = await axios
      ...
      .then((res) => {
        ...
        // setstatus('');
        handleClose();
        <Navigate to="/apps/registration/stagingPic" replace />;
        // navigate("/login");
      })
      .catch((err) => {
        setLoading(false);
      ...
      <FusePageCarded
        ...
        contentToolbar={
          <div className="flex flex-1 w-full items-center justify-between">
              ...
              <div>
                <FuseAnimate animation="transition.slideLeftIn" delay={100}>
                  ...
                  <Button variant="contained" onClick={handleClickOpens}>
                    ...
                    <div className="hidden md:contents">Add New TSS</div>
                  </Button>
                  {/* </Link> */}
                </FuseAnimate>
              </div>
            ...
            >
              <DialogTitle id="alert-dialog-title">Add New Staging TSS</DialogTitle>
              <Divider />
              <DialogContent>
...
export default StagingTSSParent;
