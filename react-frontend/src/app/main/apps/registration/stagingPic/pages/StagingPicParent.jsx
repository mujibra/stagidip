              ...
              <div>
                <FuseAnimate animation="transition.slideLeftIn" delay={100}>
                  ...
                  <Button variant="contained" onClick={handleClickOpens}>
                    ...
                    <div className="hidden md:contents">Add New PIC</div>
                  </Button>
                  {/* </Link> */}
                </FuseAnimate>
              </div>
...
export default StagingPicParent;
