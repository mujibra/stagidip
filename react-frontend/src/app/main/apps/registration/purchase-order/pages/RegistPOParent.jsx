...
import TableRegistPO from './TableRegistPO';
...
const RegistPOParent = (props) => {
  ...
  const [no_po_master, setno_po_master] = useState('');
  ...
  const body = {
    no_po_master,
    tgl_po: moment(tgl_po).format(formatDatePo),
    id_customer,
  };
  const setBody = {
    setno_po_master,
  ...
  const HandleSubmit = async (event) => {
    ...
    const response = await axios
      ...
      .then((res) => {
        ...
        setid_customer('');
        handleClose();
        <Navigate to="/apps/registration/purchaseOrder" replace />;
      })
      .catch((err) => {
        setLoading(false);
      ...
      <FusePageCarded
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <Typography className="flex items-left mt-20 sm:mb-12 flex-col" color="inherit">
                    ...
                    <Typography className="sm:font-xl sm:flex mx-0 sm:mx-12 text-xs" variant="h5">
                      List of Purchase Order Registration
                    </Typography>
                  </Typography>
                </FuseAnimate>
              </div>
        ...
        contentToolbar={
          <div className="flex flex-1 w-full items-center justify-between">
                ...
                <div>
                  <FuseAnimate animation="transition.slideLeftIn" delay={100}>
                    <Button variant="contained" onClick={handleClickOpens}>
                      ...
                      <div className="hidden md:contents">Add New PO</div>
                    </Button>
                  </FuseAnimate>
                </div>
              ) : (
            ...
            >
              <DialogTitle id="alert-dialog-title">Add New PO</DialogTitle>
              <Divider />
              <DialogContent>
