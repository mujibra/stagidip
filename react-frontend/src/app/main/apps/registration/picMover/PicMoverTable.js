...
import PicMoverTablePaginationActions from './PicMoverTablePaginationActions';
    ...
    return (
        <div className="flex flex-col sm:border-1 sm:rounded-16 overflow-hidden">
            <TableContainer className="flex flex-1"
                style={{ margin: 'auto', maxHeight: '630px' }}>
            ...
            <TablePagination
                ...
                ActionsComponent={PicMoverTablePaginationActions}
            />
        </div>
    )
}
