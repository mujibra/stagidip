  ...
  const HandleSubmit = async event => {
    ...
    const response = await axios
      ...
      .then(res => {
        ...
        setname('');
        handleClose();
        <Navigate to="/apps/registration/bacth" replace />;
      })
      .catch(err => {
        const errStatus = err.response.status;
        const errMessage = err.response.data.message;
      ...
      <FusePageCarded
        ...
        contentToolbar={
          <div className="flex flex-1 w-full items-center justify-between">
              ...
              <div>
                <FuseAnimate animation="transition.slideLeftIn" delay={100}>
                  ...
                  <Button variant="contained" onClick={handleClickOpens}>
                    ...
                    <div className="hidden md:contents">Add New Batch</div>
                  </Button>
                  {/* </Link> */}
                </FuseAnimate>
              </div>
            ...
            >
              <DialogTitle id="alert-dialog-title">Add New Batch</DialogTitle>
              <Divider />
              <DialogContent>
