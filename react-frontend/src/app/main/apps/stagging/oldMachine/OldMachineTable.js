...
const EnhancedTable = (props) => {
  ...
  const [activeErorr, setactiveErorr] = useState(false);
  const arrErr = [];
                    ...
                    if (cell.column.id === 'scan_barcode') {
                      return (
                        <TableCell className={clsx('p-4 md:p-12')}>
                          ...
                          maxLength:cell?.row?.original?.part_desc === 'UPS' ? 21 : cell?.row?.original?.part_desc === 'IT Transformer' ? 12 : 10
                          }}
                    ...
                    if (cell.column.id === 'part_no') {
                      return (
                        ...
                        >
                          ...
                          {/* <div className="py-2">{cell.render('Cell')}</div> */}
                          {/* <TextField
                            autoFocus
                            size="small"
                            InputLabelProps={{
                            ...
                            name="part_no_from_stag"
                            defaultValue={part_no_from_stag}
                            value={part_no_from_stag}
                            label="Default Part Number"
                            className="mb-2"
                          /> */}
                          <div className="flex">
                            ...
                            <Autocomplete
                              ...
                              // isOptionEqualToValue={(option, value) =>console.log(option, 'option') === console.log(value, 'val')
                              // }
                              options={dataListAll}
