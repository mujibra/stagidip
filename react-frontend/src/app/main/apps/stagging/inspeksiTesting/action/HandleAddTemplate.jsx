...
function createData(id, general_desc, detail_inspeksi, testing_inspection, in_out_info) {
  return { id, general_desc, detail_inspeksi, testing_inspection, in_out_info };
}
...
// sn_mesin,
// status,
export default function HandleAddTemplate(props) {
