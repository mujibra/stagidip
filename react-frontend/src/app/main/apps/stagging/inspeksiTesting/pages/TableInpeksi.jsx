...
export default function TableInpeksi(props) {
  ...
  // console.log(datas, 'inidatassssdasdas');
      ...
      <Paper sx={{ width: '100%', mb: 2, overflow: 'hidden' }}>
        ...
        <Dialog open={openShowData} maxWidth="lg">
          <div className="w-full flex justify-between">
            <DialogTitle id="alert-dialog-title">Pre Loading Inspection</DialogTitle>
          </div>
          <Divider />
          <DialogContent>
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell
                          ...
                          className={classes?.tableCell}
                        >
                          {row?.status_po === null ? '-' : row?.status_po}
                        </TableCell>
                        <TableCell
                          onClick={() => handleClickOpensShowData(row.id, row)}
                          align="center"
                        ...
                        <TableCell
                          ...
                          className={classes?.tableCell}
                        >
                          {row?.jml_mesin_preloading === '' ? '-' : row?.jml_mesin_preloading}
                        </TableCell>
                        <TableCell
                          onClick={() => handleClickOpensShowData(row.id, row)}
                          align="center"
