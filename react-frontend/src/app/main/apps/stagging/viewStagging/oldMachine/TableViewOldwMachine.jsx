...
export default function TablePO(props) {
  ...
  const filteredData = props?.data
    ? props?.data.filter((el) => {
        if (searched) {
          return (
            el?.no_po?.toLowerCase().includes(searched.toLowerCase()) ||
            momentFormat(el?.tgl_po, 'DD MMM YYYY').includes(searched.toLowerCase()) ||
            el?.status_po?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.customer?.bank_desc?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.jumlah?.toString().includes(searched.toLowerCase()) ||
            el?.model?.name?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.mesin?.type?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.mesin?.merek?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.batch?.name?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.part_number?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.sn_batch?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.style?.toLowerCase().includes(searched.toLowerCase()) ||
            momentFormat(el?.tahun_produksi, 'MMMM YYYY').includes(searched.toLowerCase()) ||
            el?.gudang?.gudang_desc?.toLowerCase().includes(searched.toLowerCase()) ||
            momentFormat(el?.tgl_masuk, 'DD MMM YYYY').includes(searched.toLowerCase()) ||
            momentFormat(el?.tgl_staging, 'DD MMM YYYY').includes(searched.toLowerCase()) ||
            el?.pic_staging?.name?.toLowerCase().includes(searched.toLowerCase()) ||
            el?.status_mesin?.toLowerCase().includes(searched.toLowerCase())
          );
        }
        return el;
      })
