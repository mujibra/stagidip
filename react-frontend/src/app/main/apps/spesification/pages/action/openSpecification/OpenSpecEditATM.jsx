...
const rows = MockData?.map((item, index) => createData(item?.id, item?.item_desc, item?.valueDesc));

export default function OpenSpecEditATM(props) {
  ...
  React.useEffect(() => {
    ...
    if (dataDetail.length !== 0) {
      ...
      setLanCard2Selected(dataDetail[23]?.fill_description[1]);
      setKHdmiToDvi1Selected(dataDetail[31]?.fill_description[0]);
      setKHdmiToDvi2Selected(dataDetail[31]?.fill_description[1]);
      setKHdmiToDvi3Selected(dataDetail[31]?.fill_description[2]);
