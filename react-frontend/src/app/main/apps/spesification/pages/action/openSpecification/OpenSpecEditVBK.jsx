...
export default function OpenSpecEditVBK(props) {
  ...
  React.useEffect(() => {
    ...
    if (dataDetail.length !== 0) {
      ...
      setKFasciaAtas1Selected(dataDetail[15]?.fill_description[0]);
      setKFasciaAtas2Selected(dataDetail[15]?.fill_description[1]);
      setKunciCassette1Selected(dataDetail[19]?.fill_description[0]);
      setKunciCassette2Selected(dataDetail[19]?.fill_description[1]);
      setKunciCassette3Selected(dataDetail[19]?.fill_description[2]);
      setLanCard1Selected(dataDetail[27]?.fill_description[0]);
      setLanCard2Selected(dataDetail[27]?.fill_description[1]);
      setKHdmiToDvi1Selected(dataDetail[35]?.fill_description[0]);
      setKHdmiToDvi2Selected(dataDetail[35]?.fill_description[1]);
      setKHdmiToDvi3Selected(dataDetail[35]?.fill_description[2]);
      setcustomerDisplay1Selected(dataDetail[39]?.fill_description[0]);
      setcustomerDisplay2Selected(dataDetail[39]?.fill_description[1]);
      setcustomerDisplay3Selected(dataDetail[39]?.fill_description[2]);
      setcustomerInput1Selected(dataDetail[40]?.fill_description[0]);
      setcustomerInput2Selected(dataDetail[40]?.fill_description[1]);
      ...
      setcustomerDisplay1(customerDisplay1Selected);
      setcustomerDisplay2(customerDisplay2Selected);
      setcustomerDisplay3(customerDisplay3Selected);
      setcustomerInput1(customerInput1Selected);
      setcustomerInput2(customerInput2Selected);
    }
  }, [
    dataDetail,
    memory1Selected,
    ...
    kHdmiToDvi2Selected,
    kHdmiToDvi3Selected,
    customerDisplay1Selected,
    customerDisplay2Selected,
    customerDisplay3Selected,
    customerInput1Selected,
    customerInput2Selected,
    // dataDetailSelected,
  ]);
