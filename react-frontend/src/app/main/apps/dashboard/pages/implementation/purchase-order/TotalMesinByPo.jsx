...
const TotalMesinByPo = (props) => {
  ...
  const unit = [120, 120, 130, 100, 200, 100, 130, 100];
  ...
  const options = {
    ...
    xaxis: {
      categories: ['BCA', 'BNI', 'BRI', 'MANDIRI', 'BANK JATENG', 'OCBC NISC', 'BJB', 'BTN'],
      labels: {
        style: {
          fontSize: '12px',
        },
